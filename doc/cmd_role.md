...
Mettez à jour le rôle d'un joueur (cela permet de dépasser le nombre maximum de joueurs par rôle normalement atteignable, par exemple, il est possible d'avoir 5 Loup Garou au lieu de 3) 
