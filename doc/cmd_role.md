...
Met à jour le rôle d'un joueur (permet de dépasser le nombre maximum de joueurs par rôle normalement atteignable ; par exemple, il est possible d'avoir 5 loups garou au lieu de 3) 
